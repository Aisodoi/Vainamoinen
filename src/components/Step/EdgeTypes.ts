...
import { HandleType, HandleElement, ConnectionStatus, Connection } from 'reactflow';
...
export type SmoothStepEdgeType<T> = DefaultEdge<T> & {
    type: 'smoothstep';
...
export type BezierEdgeType<T> = DefaultEdge<T> & {
    type: 'default';
